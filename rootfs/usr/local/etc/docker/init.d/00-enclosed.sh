...
# set data directory
DATA_DIR="/data/enclosed"
# set config directory
CONF_DIR="/config/enclosed"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# set the temp dir
TMP_DIR="/tmp/enclosed"
# set scripts pid dir
RUN_DIR="/run/enclosed"
# set log directory
LOG_DIR="/data/logs/enclosed"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set the working dir
...
# command to execute
EXEC_CMD_BIN='enclosed'
# command arguments
EXEC_CMD_ARGS='index.cjs'
...
# root user name
root_user_name="${ENCLOSED_ROOT_USER_NAME:-}"
# root user password
root_user_pass="${ENCLOSED_ROOT_PASS_WORD:-}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Normal user info [password/random]
# normal user name
user_name="${ENCLOSED_USER_NAME:-}"
# normal user password
user_pass="${ENCLOSED_USER_PASS_WORD:-}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Load variables from config
# Generated by my dockermgr script
[ -f "/config/env/enclosed.script.sh" ] && . "/config/env/enclosed.script.sh"
# Overwrite the variabes
[ -f "/config/env/enclosed.sh" ] && . "/config/env/enclosed.sh"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
