...
```shell
dockerHome="/var/lib/srv/$USER/docker/casjaysdevdocker/enclosed/enclosed/latest/rootfs"
mkdir -p "/var/lib/srv/$USER/docker/enclosed/rootfs"
...
services:
  ProjectName:
    ...
    environment:
      ...
      - HOSTNAME=enclosed
    volumes:
      - "/var/lib/srv/$USER/docker/casjaysdevdocker/enclosed/enclosed/latest/rootfs/data:/data:z"
      - "/var/lib/srv/$USER/docker/casjaysdevdocker/enclosed/enclosed/latest/rootfs/config:/config:z"
    ports:
      - 80:80
    restart: always
```
